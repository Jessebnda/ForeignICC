...
interface FriendInfo { id: string; name: string; photoURL?: string; }
...
export default function MessagesScreen() {
  ...
  const goToChat = (friend: FriendInfo) => {
    router.push({ pathname: '/extra/chat', params: {
      friendId: friend.id,
...
const styles = StyleSheet.create({
  ...
  card: {
    ...
    backgroundColor: '#1e1e1e', padding: 15,
    marginHorizontal: 10, marginVertical: 6,
    borderRadius: 12
  },
  avatar: { width: 45, height: 45, borderRadius: 22.5, marginRight: 12, borderWidth: 1, borderColor: '#bb86fc' },
  name: { flex: 1, color: '#fff', fontSize: 16, fontWeight: 'bold' },
